...
* **Error Scoping:** Identify specific Zerto error codes (e.g., 404 for missing VPG, 409 for task in progress) that the `@powershell-developer` must handle in the `try/catch` blocks.
